...
void dump(Darknet::Network * net, const Darknet::CfgFile::CommonParms & parms)
{
	...
	ofs	<< std::fixed << std::setprecision(6)
		...
		<< "final_learning_rate="			<< net->final_learning_rate				<< std::endl
		<< "lrf="							<< net->lrf								<< std::endl
		...
		<< "warmup_iterations="				<< net->warmup_iterations				<< std::endl
		<< "warmup_bias_lr="				<< net->warmup_bias_lr					<< std::endl
		<< "warmup_momentum="				<< net->warmup_momentum					<< std::endl
		<< "warmup_nonbias_lr_start="		<< net->warmup_nonbias_lr_start			<< std::endl
		<< "close_mosaic_epochs="			<< net->close_mosaic_epochs				<< std::endl
		<< "close_mosaic_iteration="		<< net->close_mosaic_iteration			<< std::endl
		...
		<< "augment_policy="				<< net->augment_policy					<< std::endl
		<< "flip="							<< net->flip							<< std::endl
		<< "gaussian_noise="				<< net->gaussian_noise					<< std::endl
		<< "blur="							<< net->blur							<< std::endl
		<< "mixup="							<< net->mixup							<< std::endl
		<< "hsv_h="							<< net->hsv_h							<< std::endl
		<< "hsv_s="							<< net->hsv_s							<< std::endl
		<< "hsv_v="							<< net->hsv_v							<< std::endl
		<< "degrees="						<< net->degrees							<< std::endl
		<< "translate="						<< net->translate						<< std::endl
		<< "yolov9_scale="					<< net->yolov9_scale					<< std::endl
		<< "shear="							<< net->shear							<< std::endl
		<< "perspective="					<< net->perspective						<< std::endl
		<< "flipud_prob="					<< net->flipud_prob						<< std::endl
		<< "fliplr_prob="					<< net->fliplr_prob						<< std::endl
		<< "mosaic_prob="					<< net->mosaic_prob						<< std::endl
		<< "mixup_prob="					<< net->mixup_prob						<< std::endl
		<< "copy_paste_prob="				<< net->copy_paste_prob					<< std::endl
...
//		<< "input_state_gpu="				<< dump(net->input_state_gpu)			<< std::endl -- causes segfaults
	...
	for (size_t n = 0; n < net->n; n ++)
	{
		...
		ofs	<< "--------------------------"							<< std::endl
			...
			<< "channel_start="			<< l.channel_start			<< std::endl
			<< "channel_count="			<< l.channel_count			<< std::endl
			...
			<< "use_current_update_rates=" << l.use_current_update_rates << std::endl
			<< "current_learning_rate="	<< l.current_learning_rate	<< std::endl
			<< "current_bias_learning_rate=" << l.current_bias_learning_rate << std::endl
